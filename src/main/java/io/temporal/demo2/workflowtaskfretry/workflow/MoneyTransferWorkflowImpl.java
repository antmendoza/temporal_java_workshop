...
public class MoneyTransferWorkflowImpl implements MoneyTransferWorkflow {
  ...
  public void transfer(TransferRequest transferRequest) {
    ...
    if (amount > 20) {
      ...
      // after fixing the code the workflow execution will continue from where the execution was stopped
    ...
    accountService.deposit(
        new DepositRequest(transferRequest.toAccountId(), transferRequest.referenceId(), depositAmount));
