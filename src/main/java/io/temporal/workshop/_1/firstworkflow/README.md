...
Our implementation will be simple for no, it will print a log and returns a String.
...
- [How to develop a Workflow Definition in Java](https://docs.temporal.io/dev-guide/java/foundations?lang=java#develop-workflows)
