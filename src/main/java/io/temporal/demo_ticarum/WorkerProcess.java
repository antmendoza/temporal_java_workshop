...
import io.temporal.demo_ticarum.workflow.AutomatriculaImpl;
import io.temporal.demo_ticarum.workflow.activity.AutomatriculaServiceImpl;
import io.temporal.demo_ticarum.workflow.activity.EmailServiceImpl;
...
public class WorkerProcess {
  ...
  public static void main(String[] args) {
    ...
    worker.registerActivitiesImplementations(new EmailServiceImpl());
