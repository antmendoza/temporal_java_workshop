...
/** Provides a simple standalone http server implementation of Remote Data Encoder contract.. */
public class RDEHttpServer implements Closeable {
  ...
  public synchronized void start() throws IOException {
    ...
    server.createContext(Constants.ENCODE_PATH_POSTFIX, new DataEncoderHandler(codecs));
    server.createContext(Constants.DECODE_PATH_POSTFIX, new DataEncoderHandler(codecs));
