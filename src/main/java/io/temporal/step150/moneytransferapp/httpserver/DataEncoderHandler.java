...
class DataEncoderHandler implements HttpHandler {
  ...
  public void handle(HttpExchange exchange) throws IOException {
    ...
    if (contentType == null || !contentType.startsWith(Constants.CONTENT_TYPE_APPLICATION_JSON)) {
    ...
    exchange
        .getResponseHeaders()
        .add(HttpHeaders.CONTENT_TYPE, Constants.CONTENT_TYPE_APPLICATION_JSON);
